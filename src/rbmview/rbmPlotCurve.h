...
#ifndef RBM_PLOT_CURVE_H
#define RBM_PLOT_CURVE_H
...
/*!
  ...
  with PlotCurve::Lines and no symbols. You can change this by calling
...
*/
class QWT_EXPORT PlotCurve: public QwtPlotItem
{
public:
    enum CurveType
    {
...
inline PlotData &PlotCurve::data()
{
    return *d_xy;
}
...
//! \return the the curve data
inline const PlotData &PlotCurve::data() const
{
    return *d_xy;
}
...
*/
inline double PlotCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double PlotCurve::y(int i) const
{
    return d_xy->y(i);
}

inline double PlotCurve::sd(int i) const
{
    return d_xy->sd(i);
}
