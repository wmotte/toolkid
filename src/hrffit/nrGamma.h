#ifndef __nrGamma_h__
#define __nrGamma_h__
#include <limits>
#include <cmath>
...
typedef double Doub;
typedef int Int;
typedef vnl_vector< Doub > VecDoub;
typedef bool Bool;
#define MAX std::max
#define MIN std::min
#define SQR(x) (x*x)
...
//
//  static ScalarType gammln( const ScalarType xx );
//  static ScalarType gamma( const ScalarType& x, const ScalarType& alpha, const ScalarType& beta );
//  static ScalarType hrf( const ScalarType& x, const ScalarType& f, const ScalarType& alpha1, const ScalarType& beta1, const ScalarType& alpha2, const ScalarType& beta2 );
//
//
//};
