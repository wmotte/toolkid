/*=========================================================================
  ...
  Module:    $RCSfile: itkBigMetaImageIO.cxx,v $
  Language:  C++
...
void BigMetaImageIO::PrintSelf(std::ostream& os, Indent indent) const
{
...
void BigMetaImageIO::SetDataFileName( const char* filename ) 
{ 
...
bool BigMetaImageIO::CanReadFile( const char* filename ) 
{ 
...
void BigMetaImageIO::ReadImageInformation()
{ 
...
void BigMetaImageIO::Read(void* buffer)
{ 
...
MetaImage * BigMetaImageIO::GetMetaImagePointer(void)
{
  return & m_MetaImage;
}


bool BigMetaImageIO::CanWriteFile( const char * name )
{
...
::Write( const void* buffer) 
{
  ...
  if(m_UseCompression && m_UseStreamedWriting)
    ...
    if ( !MET_SystemByteOrderMSB() )
      ...
      m_MetaImage.ElementByteOrderSwap();
      }
