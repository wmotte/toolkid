/*=========================================================================
  ...
  Module:    $RCSfile: itkBigMetaImageIO.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBigMetaImageIO_h
#define __itkBigMetaImageIO_h
...
/** \class BigMetaImageIO
 *
 *  \brief Read MetaImage file format.
 *
 *  \ingroup IOFilters
 */
class ITK_EXPORT BigMetaImageIO : public ImageIOBase
{
public:
  /** Standard class typedefs. */
  typedef BigMetaImageIO        Self;
  ...
  itkTypeMacro(BigMetaImageIO, Superclass);
...
private:
  ...
  BigMetaImageIO(const Self&); //purposely not implemented
