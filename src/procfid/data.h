...
{ \
          datafileheadSwapUnion hU;	\
          hU.out = new datafileheadSwapByte; \
          hU.in1 = pfidfileheader;	\
...
{ \
          ...
          hU.out = new datablockheadSwapByte; \
          hU.out->s1 = htons(hU.out->s1);	\
          hU.out->s2 = htons(hU.out->s2);	\
...
/**************************/
extern void movmem(char *c1, char *c2, int n , int sc1, int bytesperelem);
/**************************/
/*-------------------------------------------
|                                           |
|               movmem()/5                  |
